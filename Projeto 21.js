...
function draw() {
 ...
 if(tower.y > 400){
  ...
  if (gameState === "play") {
       // código para mover para a esquerda quando a tecla para a esquerda for pressionada
    if(keyDown("left")){
        ghost.x = ghost.x + -3;
      
    }
     // código para mover para a direita quando a tecla para a direita for pressionada
    if(keyDown("right")){
  
          ghost.x = ghost.x + 3;
      
    }
    // código para mover para cima quando a tecla espaço for pressionada
    if(keyDown("space")){
